...
export default class RXButton extends Component {
  ...
  render() {
    let { style, type, title, titleStyle, image, imageStyle, disabled,
      children, space, disabledStyle, disabledTitleStyle, disabledImageStyle, ...others } = this.props;
    ...
    if (image && title) {
      ...
      children = [image, <View style={{ width: width, height: height }} />, title].map((item, index) => {
