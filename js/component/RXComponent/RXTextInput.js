...
export default class RXTextInput extends Component {
  ...
  constructor(props) {
    super(props);
    var value = this.normalizeValue(props.value || props.defaultValue);
    this.state = {
      value,
  ...
  render() {
    let { style, type, keyboardType, maxLength, placeholderFontSize, secureTextEntry, enable, placeholder, ...other } = this.props;
